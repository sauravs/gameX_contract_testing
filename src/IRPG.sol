...
interface IRPGItemNFT {
    ...
    function getTokenStats(uint256 tokenId) external view returns (uint8, uint8, uint8, uint8);
    ...
    function isApprovedForAll(
        address owner,
        address operator // @audit available in ccip.sol
    ...
    uint256 tokenId, address newOwner, uint8 stat1, uint8 stat2, uint8 specialType, uint8 specialPoints)
        external
        returns (bool);
}
