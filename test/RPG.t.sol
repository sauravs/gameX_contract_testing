...
<<<<<<< HEAD
      ...
      function skiptestLockStatus() public {
...
<<<<<<< HEAD
  ...
  function skiptestUpgradeAndGetStat() public {
...
<<<<<<< HEAD
  // transferNft(_tokenId, senderNftContractAddress ,destinationNftContractAddress ,destinationChainId , _receiver)               
   ...
   // console2.logBytes32(messageID);     
    ...
    // verify that ccipRpgReceiver and ccipRpgSender received 100 ether

   assertEq(address(ccipRpgSender).balance, 100 ether);
